...
export function Sobre() {
    return(
        <section className="py-10 pl-5">
            <h2 className="text-2xl text-neutral-600 font-serif" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil saepe, cum architecto obcaecati ratione culpa sunt ea cumque illo, laboriosam hic impedit quisquam aliquid eos quia eum et ut. Incidunt.</h2>
